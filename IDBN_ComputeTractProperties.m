function [fa, md, rd, ad, cl, volume, TractProfile] = IDBN_ComputeTractProperties(fg,dt,numberOfNodes,clip2rois,subDir, weighting, afq)
...
% if necessary
if isstruct(fg) && isfield(fg,'subgroupNames')...
        && isfield(fg,'subgroup')
    fg = fg2Array(fg);
end
